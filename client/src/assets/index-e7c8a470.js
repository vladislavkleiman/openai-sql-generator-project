...
L.cloneElement = function (e, n, t) {
  ...
  if (n != null) {
    if (
      (n.ref !== void 0 && ((u = n.ref), (o = Qu.current)),
 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (z !== N) {
      _[0] = z;
      e: for (var Q = 0, X = _.length, bt = X >>> 1; Q < bt; ) {
        var vn = 2 * (Q + 1) - 1,
          wl = _[vn],
          hn = vn + 1,
          er = _[hn];
        if (0 > l(wl, z))
          hn < X && 0 > l(er, wl)
            ? ((_[Q] = er), (_[hn] = z), (Q = hn))
            : ((_[Q] = wl), (_[vn] = z), (Q = vn));
        else if (hn < X && 0 > l(er, z)) (_[Q] = er), (_[hn] = z), (Q = hn);
        else break e;
      }
    }
    return N;
...
function Xo(e) {
  if ((e = Jt(e))) {
    ...
    var n = e.stateNode;
    n && ((n = ol(n)), su(e.stateNode, e.type, n));
  }
}
function hs(e) {
...
var Cs = he.unstable_scheduleCallback,
  Zo = he.unstable_cancelCallback,
  Hc = he.unstable_shouldYield,
...
function Sr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Jt(t)), n !== null && eo(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function no(e, n, t, r) {
  if (Fr) {
    var l = pu(e, n, t, r);
    if (l === null) Il(e, n, r, jr, t), Jo(e, r);
...
var jr = null;
function pu(e, n, t, r) {
  if (((jr = null), (e = Ju(r)), (e = Sn(e)), e !== null))
...
function Vs(e) {
  if (e.propertyName === "value" && ll(jt)) {
    var n = [];
    $s(n, jt, e, Ju(e)), Ss(Df, n);
  }
}
function Ff(e, n, t) {
  e === "focusin"
    ? (ii(), (xt = n), (jt = t), xt.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ii();
}
function jf(e) {
...
var wu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Gf =
    typeof queueMicrotask == "function"
      ...
      : typeof vi < "u"
      ? function (e) {
          return vi.resolve(null).then(e).catch(Zf);
        }
      : wu;
function Zf(e) {
  setTimeout(function () {
...
function mn() {
  if (!jl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Cs(qu, mn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
var Vn = [],
  ...
  Ve = "";
function yn(e, n) {
  (Vn[Bn++] = Qr), (Vn[Bn++] = Br), (Br = e), (Qr = n);
}
function ea(e, n, t) {
  (we[Se++] = Ae), (we[Se++] = Ve), (we[Se++] = Nn), (Nn = e);
  var r = Ae;
  e = Ve;
  var l = 32 - Te(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function so(e) {
  for (; e === Br; )
    (Br = Vn[--Bn]), (Vn[Bn] = null), (Qr = Vn[--Bn]), (Vn[Bn] = null);
  for (; e === Nn; )
    (Nn = we[--Se]),
      (we[Se] = null),
      (Ve = we[--Se]),
...
function oa(e, n, t) {
  ...
  return (
    typeof u == "object" && u !== null
      ? (u = _e(u))
      : ((l = fe(n) ? Pn : re.current),
        (r = n.contextTypes),
        (u = (r = r != null) ? bn(e, l) : fn)),
    (n = new n(t, u)),
...
function Pu(e, n, t, r) {
  ...
  typeof u == "object" && u !== null
    ? (l.context = _e(u))
    : ((u = fe(n) ? Pn : re.current), (l.context = bn(e, u))),
...
function ho(e, n) {
  switch ((M(Qt, n), M(Bt, e), M(je, qt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Ca(e, n, t) {
  return zn & 21
    ? (Oe(t, n) || ((t = Ns()), ($.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
...
function Mi(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Pr(e, n), oa(n, t, r), Pu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Lu(e, n, t, r, l, u) {
  Ma(e, n);
  var o = (n.flags & 128) !== 0;
  if (!r && !o) return l && gi(n, t, !1), Ke(e, n, u);
...
function Di(e, n, t, r, l) {
  return et(), ao(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
  ...
  switch ((so(n), n.tag)) {
    ...
    case 6:
      if (e && n.stateNode != null) $a(e, n, e.memoizedProps, r);
        ...
        if (((t = En(Qt.current)), En(je.current), dr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Ie] = n),
    ...
    case 4:
      return (
        tt(), Ou(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function vd(e, n) {
  ...
  for (yu = { focusedElem: e, selectionRange: t }, Fr = !1, k = n; k !== null; )
...
function Aa(e) {
  ...
  n !== null && ((e.alternate = null), Aa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[Su], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, n, t) {
  for (var r = (e.mode & 1) !== 0; k !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (k = u)) : $i(e);
  }
}
function $i(e) {
  for (; k !== null; ) {
...
function Re(e, n, t, r) {
  if (50 < Tt) throw ((Tt = 0), (Uu = null), Error(y(185)));
  Gt(e, t, r),
    (!(R & 2) || e !== Z) &&
      (e === Z && (!(R & 2) && (fl |= t), Y === 4 && qe(e, q)),
      de(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((lt = H() + 500), il && mn()));
}
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Zo(t), n === 1))
      e.tag === 0 ? bf(Bi.bind(null, e)) : bs(Bi.bind(null, e)),
        Gf(function () {
          !(R & 6) && mn();
        }),
        (t = null);
...
function Wa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = br(e, r);
    ...
    R |= 2;
    var u = Ya();
    (Z !== e || q !== n) && ((Ue = null), (lt = H() + 500), _n(e, n));
    do
      try {
        Sd();
        break;
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Yt), _n(e, 0), qe(e, r), de(e, H()), t);
    if (n === 6) qe(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = No + 500 - H()), 10 < n))
          ) {
            if (Ir(e, 0) !== 0) break;
  ...
  return de(e, H()), e.callbackNode === t ? Wa.bind(null, e) : null;
}
function $u(e, n) {
  var t = Lt;
  return (
...
function Bi(e) {
  ...
  if (t === 1) throw ((t = Yt), _n(e, 0), qe(e, n), de(e, H()), t);
...
function _n(e, n) {
  ...
  if ((t !== -1 && ((e.timeoutHandle = -1), Xf(t)), W !== null))
...
function To() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(Ln & 268435455) && !(fl & 268435455)) || qe(Z, q);
}
function br(e, n) {
  var t = R;
  R |= 2;
  ...
  while (1);
  if ((fo(), (R = t), (Zr.current = r), W !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function wd() {
  for (; W !== null; ) Xa(W);
...
function kd(e, n, t, r) {
  ...
  if (Jr) throw ((Jr = !1), (e = ju), (ju = null), e);
  return (
    qr & 1 && e.tag !== 0 && Jn(),
    (u = e.pendingLanes),
    u & 1 ? (e === Uu ? Tt++ : ((Tt = 0), (Uu = e))) : (Tt = 0),
    mn(),
    null
  );
}
...
function Ed(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (q & t) === t &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > H() - No)
        ? _n(e, 0)
        : (Po |= t)),
    de(e, n);
}
function Za(e, n) {
  n === 0 &&
    (e.mode & 1
      ...
      : (n = 1));
  var t = ue();
  (e = We(e, n)), e !== null && (Gt(e, n, t), de(e, t));
}
function _d(e) {
  var n = e.memoizedState,
    t = 0;
...
Ja = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && ea(n, Qr, n.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (bu(n, t | 1), de(n, H()), !(R & 6) && ((lt = H() + 500), mn()));
      }
      break;
    case 13:
      Tn(function () {
...
gs = zo;
ws = Tn;
var Rd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, hs, ys, zo] },
  yt = {
...
var Ki = Yl;
(Kl.createRoot = Ki.createRoot), (Kl.hydrateRoot = Ki.hydrateRoot);
const Md = "_main_m8fsz_31",
  Dd = "_icon_m8fsz_57",
  Id = "_result_m8fsz_127",
  Yi = { main: Md, icon: Dd, result: Id },
  Fd = "/assets/sql-server-d770f38c.png";
function jd() {
  const [e, n] = xn.useState(""),
    [t, r] = xn.useState(""),
    l = async (o) => {
      o.preventDefault();
      const i = await u();
    ...
    u = async () =>
      (
        await (
          await fetch("https://sql-generator-gqqz.onrender.com/api/generate", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ queryDescription: e }),
          })
        ).json()
      ).sqlQuery;
  return Ao("main", {
    className: Yi.main,
    children: [
      wn("img", { src: Fd, className: Yi.icon, alt: "SQL server" }),
      wn("h3", { children: "Generate SQL" }),
      Ao("form", {
        onSubmit: l,
        children: [
          wn("input", {
          ...
          wn("input", { type: "submit", value: "Generate query" }),
        ],
      }),
      wn("pre", { children: t }),
    ],
...
Kl.createRoot(document.getElementById("root")).render(
  wn(kc.StrictMode, { children: wn(jd, {}) })
);
